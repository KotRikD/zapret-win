...
set ZAPRET_ARGS_UDP=--dpi-desync=fake --dpi-desync-autottl=5 --dpi-desync-repeats=10 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BASE%files\quic_initial.bin" --dpi-desync-cutoff=n2
...
--comment "Discord/STUN"           --filter-udp=2000-3000,8443,19000-19500,50000-65535 --filter-l7=discord,stun --dpi-desync=fake --dpi-desync-fake-discord="%BASE%files\quic_initial_dbankcloud_ru.bin" --dpi-desync-fake-stun="%BASE%files\quic_initial_dbankcloud_ru.bin" --dpi-desync-repeats=10 --new ^
